...
LOCAL_CFLAGS := -Wall -Wextra -Werror -DLOG_NDEBUG=0
...
LOCAL_C_INCLUDES := \
        ...
        $(TOP)/hardware/qcom/media-caf-msm8996-los/libstagefrighthw \
        $(TOP)/hardware/qcom/media-caf-msm8996-los/mm-core/inc \
